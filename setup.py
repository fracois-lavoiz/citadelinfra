"""Setup configuration for citadelinfra."""
...
setup(
    ...
    description="Secure infrastructure orchestration, containerized deployments, and integrity verification",
    long_description=open("README.md").read(),
    long_description_content_type="text/markdown",
    url="https://github.com/fracois-lavoiz/citadelinfra",
